...
public class Server extends UnicastRemoteObject implements ServerRemote {
    ...
    public static void main (String[] args) {
        try {
		    ...
		    // Get registry
		    Registry registry = LocateRegistry.getRegistry(localServer.getServerIP(1), localServer.getServerPort(1));
            registry.rebind("RemoteAccess", localServer);
            System.out.println("Server started: " + localServer.getServerPort(1));
